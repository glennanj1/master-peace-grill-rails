...
module MasterPeaceGrillRails
  class Application < Rails::Application
    ...
    config.middleware.use ActionDispatch::Cookies
    config.middleware.use ActionDispatch::Session::CookieStore, key: '_john_cookie', expire_after: 10.minutes , secure: Rails.env.production?, same_site: 'None'
